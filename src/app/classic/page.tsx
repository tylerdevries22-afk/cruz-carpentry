...
// The content-rich classic home. The cinematic tour is the default experience at
// `/`, but this page stays the canonical, search-indexed homepage (full copy +
// LocalBusiness structured data). Title/description inherit the site defaults.
