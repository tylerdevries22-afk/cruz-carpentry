...
export function Services({ showHeader = true }: { showHeader?: boolean } = {}) {
  ...
  return (
    <section id="services" ref={sectionRef} className="relative bg-[#FAF7F2] py-28 sm:py-36 px-6 overflow-hidden">
      ...
      >
        <Image src="https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_grain_g2.jpg" alt="" fill className="object-cover" sizes="100vw" />
      </motion.div>
