...
export const chapters: Chapter[] = [
  {
    ...
    image: "https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_raw_g2.jpg",
    headline: "It starts with the wood.",
    sub: "Selected. Inspected. Respected.",
    filters: { brightness: 0.66, contrast: 1.05, saturate: 1.0, sepia: 0 },
    overlayOpacity: 0.55,
  },
  {
    id: "grain",
    ...
    image: "https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_grain_g2.jpg",
    headline: "Every grain tells a story.",
    sub: "No two pieces are ever the same.",
    filters: { brightness: 0.86, contrast: 1.06, saturate: 1.0, sepia: 0 },
    overlayOpacity: 0.35,
  },
  {
    id: "measure",
    ...
    image: "https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_measure_g2.jpg",
    headline: "Measured twice. Cut once.",
    sub: "Precision is the foundation of craft.",
    filters: { brightness: 0.9, contrast: 1.04, saturate: 1.0, sepia: 0 },
    overlayOpacity: 0.25,
  },
  {
    id: "cut",
    ...
    image: "https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_cut_g2.jpg",
    headline: "Clean. Decisive. Exact.",
    sub: "Every cut is an act of commitment.",
    filters: { brightness: 0.84, contrast: 1.07, saturate: 1.0, sepia: 0 },
    overlayOpacity: 0.3,
  },
  {
    id: "sand",
    ...
    image: "https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_sand_g2.jpg",
    headline: "Rough becomes smooth.",
    sub: "Patience is what separates good from great.",
    filters: { brightness: 0.92, contrast: 1.03, saturate: 1.0, sepia: 0 },
    overlayOpacity: 0.2,
  },
  {
    id: "assemble",
    ...
    image: "https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_assemble_g2.jpg",
    headline: "Pieces become purpose.",
    sub: "Joinery that holds for generations.",
    filters: { brightness: 0.95, contrast: 1.03, saturate: 1.0, sepia: 0 },
    overlayOpacity: 0.15,
  },
  {
    id: "finish",
    ...
    image: "https://nkarcozbgtgtcqfhytrx.supabase.co/storage/v1/object/public/what-we-build/general/real-photos/wood_finish_g2.jpg",
    headline: "Built by hand. Built to last.",
    sub: "Cruz Carpentry — Custom Millwork",
    filters: { brightness: 0.96, contrast: 1.02, saturate: 1.0, sepia: 0 },
    overlayOpacity: 0.1,
  },
];
